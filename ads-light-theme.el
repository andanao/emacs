...
;;;; face categories -- required for all themes
  ...
  (((font-lock-comment-face &override)
   ...
   (org-level-1 :height 1.5 :foreground base8 )
   (org-level-2 :height 1.4 :foreground base8 )
   (org-level-3 :height 1.3 :foreground base8 )
   (org-level-4 :height 1.2 :foreground base8 )
   (org-level-5 :height 1.15 :foreground base8 )
   ...
   (org-property-value :foreground cyan :inherit 'fixed-pitch)
