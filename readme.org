...
#+PROPERTY: header-args:emacs-lisp :tangle ./readme.el :comments link :results none
* Set background
:PROPERTIES:
...
** Bookmarks
:PROPERTIES:
:ID:       c54c63c8-13a7-4265-96c4-0bdde31bc410
:END:
#+begin_src emacs-lisp
...
*** Git stage commit --amend and push-f
:PROPERTIES:
:ID:       395fd074-493c-421e-a6a2-38342b440ce3
:END:
Useful I'm only writing code that I can't test on my local compuyter and has to be synced via get, keeps the logs a bit cleaner. me and I'm lazy AF and testing somewhere else..  ~git lazy~
#+begin_src emacs-lisp
...
* Auto tangle files
:PROPERTIES:
:ID:       60c0d70c-1753-4e60-ad6d-79c56cd22e48
:END:
