...
(defun ads/modus-tweaks ()
  (modus-themes-with-colors
    (custom-set-faces
     ...
     `(org-drawer ((,c :height 0.7)))
     `(org-property-value ((,c :height 0.7)))
...
** anki-editor
[[id:4a1d6172-5ca4-4c79-8ca4-7e931e1001e8][ [[https://github.com/anki-editor/anki-editor][anki-editor]] for emacs. [[https://yiufung.net/post/anki-org/][These]] [[https://rgoswami.me/posts/anki-decks-orgmode/][blog posts]] showing quite sophisticated emacs and
...
- [ ] Clear
  ...
  - [ ] Downloads
- [ ] Clean Apartment
- [ ] Upgrade packages ~(package-upgrade-all)~
...
#+end_src
*** org monthly review
Template for my monthly reviews
...
#+begin_src emacs-lisp
(setq org-archive-location (concat (ads/roam-daily-today) "::* Archive")
