...
(use-package claude-code-ide
  ...
  (ads/leader-keys
    ...
    "ai" 'claude-code-ide
    "aa" 'claude-code-ide-toggle
    "aA" 'claude-code-ide-show-all
    "am" 'claude-code-ide-menu
    "an" 'claude-code-ide-rename-session
    "aR" 'claude-code-ide-resume
    "ac" 'claude-code-ide-continue
    "aQ" 'claude-code-ide-stop
    "aX" 'claude-code-ide-stop-all
    "ar" 'claude-code-ide-send-region
    "ab" 'claude-code-ide-send-buffer
    "af" 'claude-code-ide-send-file
    "ap" 'claude-code-ide-send-prompt
    "al" 'claude-code-ide-list-sessions
    "as" 'claude-code-ide-switch-to-buffer
    "a@" 'claude-code-ide-insert-at-mentioned
    "at" 'claude-code-ide-toggle-recent
    ))
#+end_src
