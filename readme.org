...
(defun ads/resize-h ()
  ...
  (cond
   ...
   (ads/resize-selected-separator
    (ads/resize--move-selected (- ads/window-resize-step)))
   ;; No selection yet
   (t (let ((left-win (window-in-direction 'left))
        ...
        (cond
         ...
         ((and right-win (not left-win))
          (adjust-window-trailing-edge (selected-window) (- ads/window-resize-step) t))
         ;; Only separator to left -> move it left
         ((and left-win (not right-win))
          (adjust-window-trailing-edge left-win (- ads/window-resize-step) t))
   ...
   (t (let ((above-win (window-in-direction 'above))
        ...
        (cond
         ...
         ((and below-win (not above-win))
          (adjust-window-trailing-edge (selected-window) (- ads/window-resize-step) nil))
         ;; Only separator above -> move it up
         ((and above-win (not below-win))
          (adjust-window-trailing-edge above-win (- ads/window-resize-step) nil))
