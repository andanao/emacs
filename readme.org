...
(defcustom ads/window-resize-step 25
  "Number of columns/rows to resize by for normal movement."
  :type 'integer
  :group 'convenience)

(defcustom ads/window-resize-step-fine 5
  "Number of columns/rows to resize by for fine movement."
  :type 'integer
  :group 'convenience)

(transient-define-prefix ads/window-resize-transient ()
  "Resize windows by moving edges."
  :transient-suffix 'transient--do-stay
  :transient-non-suffix 'transient--do-quit-all
  [["Move edge"
    ("h" "← left"  (lambda () (interactive) (enlarge-window-horizontally (- ads/window-resize-step))))
    ("l" "→ right" (lambda () (interactive) (enlarge-window-horizontally ads/window-resize-step)))
    ("k" "↑ up"    (lambda () (interactive) (enlarge-window (- ads/window-resize-step))))
    ("j" "↓ down"  (lambda () (interactive) (enlarge-window ads/window-resize-step)))]
   ["Fine"
    ("H" "← left"  (lambda () (interactive) (enlarge-window-horizontally (- ads/window-resize-step-fine))))
    ("L" "→ right" (lambda () (interactive) (enlarge-window-horizontally ads/window-resize-step-fine)))
    ("K" "↑ up"    (lambda () (interactive) (enlarge-window (- ads/window-resize-step-fine))))
    ("J" "↓ down"  (lambda () (interactive) (enlarge-window ads/window-resize-step-fine)))]
   ["Layout"
