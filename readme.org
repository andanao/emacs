...
** org-download
better management of images in org mode
#+begin_src emacs-lisp
...
** org clip image
[[org-download]] doesn't work with my work computer even when specifying
imagemagick.  Instead pull the image from the clipboard and do some crap in powershell
