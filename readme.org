...
an indirect clone in another window so the base buffer stays widened."
  ...
  (cond
   ((derived-mode-p 'org-mode)
    ...
    (org-fold-show-all))
   ((derived-mode-p 'markdown-mode) (markdown-narrow-to-subtree))
...
Use a stipple to show indentation
...
(use-package markdown-mode
  ...
  (markdown-max-image-size '(1000 . nil))
  :config
...
=RET= follows the thing at point.

#+begin_src emacs-lisp
(general-define-key
 :states '(normal) :keymaps '(markdown-mode-map markdown-view-mode-map)
...
(general-define-key
 :states '(motion) :keymaps '(markdown-mode-map markdown-view-mode-map)
...
(ads/leader-keys
  ...
  "oh" 'consult-outline
  "o TAB" 'markdown-shifttab
  "ol" 'markdown-insert-link
  "ti" 'markdown-display-inline-images
  "tI" 'markdown-toggle-inline-images
  "tm" 'markdown-toggle-markup-hiding
  "tu" 'markdown-toggle-url-hiding
  "ne" 'markdown-narrow-to-subtree
