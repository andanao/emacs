...
own agent-shell module, which binds the same map."
  (when (or (null mode) (eq mode 'agent-shell))
    (general-define-key
     ...
     "0" (ads/image-key ads/agent-shell--on-image-p 'agent-shell-image-scale-reset))))
