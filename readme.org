...
(ads/leader-keys
    "j" '(:ignore t :wk "Toggl")
    "et" '(ads/toggl-config :wk "Toggl config")
    "jt" '(ads/toggl-config :wk "Toggl config")
    "jj" '(ads/toggl-start-interactive :wk "Toggl start")
    "js" '(ads/toggl-stop :wk "Toggl stop")
    "jr" '(ads/toggl-resume :wk "Toggl resume")
)
