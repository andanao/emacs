...
(use-package vterm
    :config
    ;; Let evil-collection handle vterm (insert state by default)
    ;; ESC -> normal for navigation, i/a -> insert for typing
...
(use-package vterm-toggle
  ...
  (vterm-toggle-togglable-buffer-functions
   '((lambda (buf) (not (string-prefix-p "*claude-code" (buffer-name buf))))))
  :config
  (ads/leader-keys
    ";" 'vterm-toggle))
#+end_src
