...
These keybingings live directly under leader with no sub menu
#+begin_src emacs-lisp
(ads/leader-keys
  "C-SPC" 'bookmark-jump
...
(ads/leader-keys
  ...
  "jF" 'delete-window
  "jd" 'kill-current-buffer
  "jD" 'kill-buffer-and-window
...
(customize-set-variable 'line-spacing 0.2)
#+end_src

*** Org

#+begin_src emacs-lisp
;(set-face-attribute 'org-document-title nil :height 1.5 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-1 nil :height 1.35 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-2 nil :height 1.3 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-3 nil :height 1.25 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-4 nil :height 1.2 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-5 nil :height 1.15 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-6 nil :height 1.1 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-7 nil :height 1.1 :inherit 'variable-pitch)
;(set-face-attribute 'org-level-8 nil :height 1.1 :inherit 'variable-pitch)
;(set-face-attribute 'org-code nil :inherit 'fixed-pitch)
;(set-face-attribute 'org-block nil :inherit 'fixed-pitch)
;(set-face-attribute 'org-block-end-line nil :height 0.8 :inherit 'fixed-pitch)
;(set-face-attribute 'org-block-start-line nil :height 0.8 :inherit 'fixed-pitch :underline t)
