...
Set frame padding to have some breathing room
#+begin_src emacs-lisp
(defun ads/set-frame-padding (pad)
  (modify-all-frames-parameters
   `((right-divider-width . ,pad)
     (internal-border-width . ,pad)))
  )
(ads/set-frame-padding 40)
#+end_src
...
(add-hook 'modus-themes-after-load-theme-hook 'modus-themes-invisible-dividers)
#+end_src
...
for bookmarks see [[id:6298ee0c-0bd9-41c3-88bb-d9d0159c14b7][bookmark+]] 
